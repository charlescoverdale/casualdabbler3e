...
# Other Utilities
library(strayr)      # Australian Bureau of Statistics map data
...
The easiest way to do this is using the `strayr` package — it downloads ABS shapefiles on demand without needing to install a large data package.
